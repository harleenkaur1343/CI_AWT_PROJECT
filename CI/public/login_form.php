...
<body>
    <div class="form-cont d-flex flex-column align-items-center">
        <h3>Zavme Login</h3>
        <form class="d-flex flex-column align-content-center align-items-start" method="post" action="User">
        ...
        <div class="other-signin d-flex align-items-center justify-content-center">
            Sign in with Google&nbsp;&nbsp;&nbsp;&nbsp;
            <img src="images/logos_google-icon.svg" alt="google-icon">
        </div>
        <br><br>
        <div class="row container-fluid bottom-text-cont">
            <div class="col-7 d-flex flex-column justify-content-start align-items-start">
                <span>Don't have an account?</span><span><a href="http://localhost/CI/public/signup_form.html" style="color:#FFADBC;"><b>Sign up</b></a></span>
            </div>
